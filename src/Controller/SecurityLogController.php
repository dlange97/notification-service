...
#[Route('/notification/admin/security-log', name: 'notification_security_log_')]
class SecurityLogController extends AbstractController
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return $this->json($this->securityLogService->getPaginatedList($page, $perPage, 'notification'));
    }
